...
describe("smoke tests", () => {
  ...
  it("should allow you to make a task, check for the correct info, edit it, duplicate it, and delete it", () => {
    ...
    cy.get('[data-cy="project-PERSONAL"]', { timeout: 1000 })
      .should("exist")
      .click();
    ...
    cy.get('[data-cy="editTaskTitle"]', { timeout: 1000 })
      .clear()
      .type(newTaskTitle, { force: true });
  ...
  it("should allow you to make a project, edit it, and delete it", () => {
    ...
    cy.wait(1000);
    cy.get(`[data-cy="project-${testProject.title.toUpperCase()}"]`)
      .should("exist")
      .click();
